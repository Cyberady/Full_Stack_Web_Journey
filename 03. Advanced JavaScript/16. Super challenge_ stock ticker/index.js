...
setInterval(function() {
    ...
    renderStockerTicker(stockData)
}, 1500)

function renderStockerTicker(stockData) {
    ...
    const priceDirectionColor =
        numericPrice > prevPrice ? "green" :
        numericPrice < prevPrice ? "red" :
        "grey"
    ...
    stockDisplayPriceIcon.textContent = priceDirectionIcon
    stockDisplayPriceIcon.style.color = priceDirectionColor
...
- The triangle compares the current stock price to its previous price. If the price has increased, 
  it should be a green triangle pointing up, if the price has decreased it should be a red triangle 
  pointing down, and if there has been no change it should be a grey triangle pointing to the right.
...
⚠️ You will need to write code here in index.js and in fakeStockAPI.js.
*/
